...
def main():
    ...
    required_args.add_argument('-o', '--output_simulations', required=True, help="Path to the output JSON file. Accepted formats: json (edam:format_3464).")
    ...
    MemProtMDSimList(output_simulations=args.output_simulations, properties=properties).launch()
