...
class TestPdb():
    def setUp(self):
        json_config='{"working_dir_path":"/tmp/biobb/unitests", "paths":{"output_pdb_path":"output_pdb_path.pdb", "reference_output_pdb_path":"file:test_reference_dir/api/pdb_1ubq.pdb"}, "properties":{"pdb_code":"1UBQ"}}'
